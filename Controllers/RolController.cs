    ...
    public class RolController : Controller
    {
        ...
        public RolCLS listarPaginasRecuperar(int idRol)
        {
            ...
            using (M_VPSA_V3Context bd = new M_VPSA_V3Context())
            {
                ...
                List<PaginaCLS> listaPaginas = (from rolUsuario in bd.Rol
                                                join paginaRol in bd.Paginaxrol
                ...
                Rol oRol = bd.Rol.Where(prop => prop.IdRol == idRol).First();
        ...
        public int eliminarRol(int idRol)
        {
            ...
            try
            {
                using (M_VPSA_V3Context bd = new M_VPSA_V3Context())
                {
                    Rol oRol = bd.Rol.Where(p => p.IdRol == idRol).First();
                    oRol.Bhabilitado = 0;
                    bd.SaveChanges();
                    rpta = 1;
                }
