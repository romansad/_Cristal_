...
@Component({
  selector: 'tabla-trabajo',
  templateUrl: './tabla-trabajo.component.html',
  styleUrls: ['./tabla-trabajo.component.css']
})
export class TablaTrabajoComponent implements OnInit {
